...
def init():
    ...
    locations_data = [
        ...
        ("Brockman Hall", 29.719657512578248,  -95.40156544571923), #no edges
        ...
        ("Keck Hall", 29.71976632116094, -95.40013150519043),
        ("Herzstein Hall", 29.719403657626334, -95.39848599355855),
        ("Rayzor Hall", 29.718120367743776, -95.39900093604061),
        ("OEDK", 29.72116327508793, -95.40133636100799),
        ("Seibel Servery", 29.716084031365074, -95.39842266057019),
        ("South Servery", 29.715242758586513, -95.40123732322901),
        ("South Servery", 29.715242758586513, -95.40123732322901),
        ("North Servery", 29.72184831856997, -95.39780644980041),
        ("West Servery", 29.721168270600494, -95.39843436807233),
        ("Baker Servery", 29.71702236643668, -95.39921793342828)
    ]
